...
public class HopperOmni extends CommandBase {
  ...
  @Override
  public void execute() {
    hopperOmniSubsystem.SetHopperSpeed(DriveTrainMain.scaleInputs(operator.getRawAxis(ControlConstants.operatorLeftY))*.4);
    hopperOmniSubsystem.SetOmniSpeed(DriveTrainMain.scaleInputs(operator.getRawAxis(ControlConstants.operatorRightY)));
  }
